<header class="main-header">
    ...
    <a href="{{route('panel.index')}}" class="logo">
      ...
      <span class="logo-lg"><b>Masia</b> Can Cruz</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/images/descarga.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Bruna Gomes</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="/images/descarga.jpg" class="img-circle" alt="User Image">
