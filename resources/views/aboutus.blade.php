        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="about-img-box">
                    <img src="images/frente-masia.jpg" alt="" class="img-fluid">
                </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="images/comida1.jpg" alt="" class="img-d img-fluid">
              </div>
          ...
          <div class="col-md-4">
            <div class="card-box-d">
                <div class="card-img-d">
                    <img src="images/neve.jpg" alt="" class="img-d img-fluid">
                </div>
                <div class="card-overlay card-overlay-hover">
                    <div class="card-body-d">
                        <p class="content-d color-text-a">
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="images/janela.jpg" alt="" class="img-d img-fluid">
              </div>
              <div class="card-overlay card-overlay-hover">
                    <div class="card-body-d">
                        <p class="content-d color-text-a">
                          El mateix criteri hem seguit a l’incorporar  mobiliari, objectes i roba de llar, on ha primat la recuperació de mobles i electrodomèstics per tal de donar-los una segona oportunitat. En els tèxtils, estores, cortines i llençols, hi són presents les fibres naturals com la llana, el cotó i el lli.
                        </p>
                    </div>
                </div>
              </div>
