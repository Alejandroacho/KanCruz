    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="property-grid.html">Reservas</a>
          </li>
          <li class="nav-item">
                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <h1 class="intro-title mb-4">
                       Relájate en nuestras habitaciones 
                      <br><span class="color-b">rústicas y confortables </span></h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">Reserva</span></a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <h1 class="intro-title mb-4">
                      Desconnecta en un entorno inmejorabl
                      <br> en medio del<span class="color-b">Montseny</span></h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">Reserva</span></a>
                    </p>
                  </div>
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <h1 class="intro-title mb-4">
                    Concina <span class="color-b">ecológica </span> con
                    <br> productos de nuestra <span class="color-b">huerta </span></h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">Reserva</span></a>
                    </p>
                  </div>
